...
import com.cypal.ming.paotui.bean.CarshAccountBean;
 ...
 * @version 提现账号 账户列表
 */
public class CashAccountListActivity extends BaseActivity implements TextWatcher, AuthCodeDialog.onConfirmListener {
    ...
    private void delAccount(String pay_pass_token) {
        ...
        mQueue.add(ParamTools.packParam(Const.delAccount, this, this, map));
    }
