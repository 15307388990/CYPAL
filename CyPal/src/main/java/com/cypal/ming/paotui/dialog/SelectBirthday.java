package com.cypal.ming.paotui.dialog;
...
import com.cypal.ming.paotui.view.NumericWheelAdapter;
import com.cypal.ming.paotui.view.OnWheelChangedListener;
import com.cypal.ming.paotui.view.WheelView;
...
public class SelectBirthday extends PopupWindow implements OnClickListener {
    ...
    private onConfirmListener firmListener = null;

    public SelectBirthday(Activity context, String age, TextView textView, onConfirmListener firmListener) {
        super(context);
        mContext = context;
        this.age = age;
        this.textView = textView;
        this.firmListener = firmListener;
