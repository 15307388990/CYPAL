package com.cypal.ming.paotui.adapter;
...
import com.cypal.ming.paotui.bean.Msgmodel;
import com.cypal.ming.paotui.bean.SettleListBean;
...
public class CashFreezeAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        viewHolder.tv_timer.setText(Tools.getDateformat2(financeSettle.getOrder_date()));
        // 4 此商品为POS订单
        if (financeSettle.getSettle_type() == 4) {
            ...
            msgmodels = JSON.parseArray(spec, Msgmodel.class);
            if (msgmodels != null) {
                if (msgmodels.size() > 1) {
                    ...
                    viewHolder.tv_name.setText("无人售货机分佣所得");
