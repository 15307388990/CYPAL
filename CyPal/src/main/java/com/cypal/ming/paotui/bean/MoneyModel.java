package com.cypal.ming.paotui.bean;
...
public class MoneyModel implements Serializable {
    ...
    private int withdraw_stauts;//提现状态 0； 提现中 1；提现成功 -1提现失败
    ...
    private long withdraw_end_date;//	提现完成时间

    private String admin_id;//确认完成提现的操作人
    ...
    public long getWithdraw_end_date() {
        return withdraw_end_date;
    }

    public void setWithdraw_end_date(long withdraw_end_date) {
