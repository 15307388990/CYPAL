...
/**
 * @author luoming 添加吹牛皮收款账号
 */
public class SaveCnpAccountAcitity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acitity_save_cnp_account);
        initView();
    }
    ...
    private void initView() {
        ...
        right_view_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SaveCnpAccountAcitity.this);
        ...
        try {
            CodeUtils.analyzeBitmap(path, new CodeUtils.AnalyzeCallback() {
                ...
                public void onAnalyzeFailed() {
                    Tools.showToast(SaveCnpAccountAcitity.this, "无法解析图片二维码，请重新选择");
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
        ...
        AndPermission.with(this)
                ...
                onGranted(new Action<List<String>>() {
                    ...
                    public void onAction(List<String> data) {
                        accountData = null;
                        Intent intent = new Intent(SaveCnpAccountAcitity.this,
                ...
                onDenied(new Action<List<String>>() {
                    @Override
                    public void onAction(List<String> data) {
                        Tools.showToast(SaveCnpAccountAcitity.this, "需要获取相册权限");
                    }
                }).
                start();
