...
public class TopUpDetailListAdapter extends RecyclerView.Adapter<TopUpDetailListAdapter.ViewHoler> {
    ...
    public TopUpDetailListAdapter(Context context, List<IndexEntity.DataBean.UndoOrderBean.ContentBean> list, OnClickListener onClickListener) {
